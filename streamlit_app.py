...
from blog_summarize import summarize_blog, set_openai_api_key
import sys
sys.path.append("..")
from blog_loader import CHINESE, ENGLISH  # noqa: E402
...
st.button("确定", on_click=set_openai_api_key(st.session_state.key))
